...
public class CustomerScrollerView extends ScrollView {
    ...
    public CustomerScrollerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomerScrollerView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CustomerScrollerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//		}
    ...
    public interface OnHeaderRefreshListener {
        public void onHeaderRefresh(CustomerScrollerView view);
    }
