...
import com.sample.toolbar.adapter.HeaderAdAdapter;
import com.sample.toolbar.manager.ImageManager;
...
/**
 * 头部广告banner的View，一个可以循环的ViewPager
 */
...
//        ButterKnife.bind(this, view);
    ...
    private void dealWithTheView(List<String> list) {
        ...
        for (int i = 0; i < size; i++) {
            ivList.add(createImageView(list.get(i)));//添加imageView到集合中
        }
    ...
    private void addIndicatorImageViews(int size) {
        llIndexContainer.removeAllViews();//移除所有的view
        for (int i = 0; i < size; i++) {
