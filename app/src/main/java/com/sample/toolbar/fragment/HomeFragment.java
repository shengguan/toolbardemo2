...
import com.sample.toolbar.activity.ToolBarDemoActivity;
 ...
 */
public class HomeFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, ListAdapter.OnItemClickListener {
...
//        mSwipeRefreshLayout.setColorSchemeResources(android.R.color.holo_blue_bright);
        ...
        mSwipeRefreshLayout.setProgressBackgroundColorSchemeColor(mContext.getResources().getColor(R.color.ripple));
//        mSwipeRefreshLayout.setProgressBackgroundColorSchemeColor(R.color.ripple);
        ...
        mFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(mContext, ToolBarDemoActivity.class));
            }
        });
