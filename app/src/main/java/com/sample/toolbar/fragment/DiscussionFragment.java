...
import com.sample.toolbar.activity.ZoomRecycleview;
 ...
 */
public class DiscussionFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, ListAdapter.OnItemClickListener {
    ...
    public View initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(mContext, ZoomRecycleview.class));
            }
        });
